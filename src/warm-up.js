...
var vegetables = ['broccoli', 'carrot', 'lettuce','cucumber','cauliflower'];
...
// different fruits.
var fruits = ['apples','oranges','strawberries','lemons','tangerines','bananas','kiwis'];
...
groceryStore.key = 'Denver, Colorado'
